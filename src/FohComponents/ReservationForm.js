    ...
    return (<div className="outer-res">
      ...
      <div className="form res-form" style={{
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Input label="Name" name="guest_name" value={this.state.guest.guest_name} onChange={this.handleChange} style={{
              width: "60%"
          }} required="required"/>
          ...
          <Form.Input label="Date" type="date" name="date" value={this.state.guest.date} onChange={this.handleChange} style={{
              width: "200px"
          }} required="required"/>

          <Form.Input label="Time" type="time" name="time" value={this.state.guest.time} onChange={this.handleChange} style={{
              width: "100px"
          }} required="required"/>

          <Form.TextArea label="Special Requests" rows="4" name="special_requests" value={this.state.guest.special_requests} onChange={this.handleChange} style={{
              width: "75%"
          }}/>
          ...
          <Modal trigger={<Button disabled = {
            ...
            <Modal.Content>
              <h3>
                Make reservation for {this.state.guest.guest_name}
                +{this.state.guest.number_of_guests - 1}<br/>
                on {this.state.guest.date}<br/>at {this.state.guest.time}?
              </h3>
            </Modal.Content>
            <Modal.Actions>
              ...
              <Button onClick={this.handleMakeReservation} color='green' inverted="inverted">
                <Icon name='checkmark'/>
                Yes
              </Button>
            </Modal.Actions>
