...
<div className="whole-div">
  <Grid className="whole-grid">
    ...
    <Grid.Column className="foh-side" width={4}>
      ...
      {this.props.currentTab === "tables" ? (<div><Grid.Row><OpenTableList /></Grid.Row><Grid.Row><SeatedTableList /></Grid.Row></div>) : this.props.currentTab === "reservations" ? (<ReservationList />) : (<WaitlistList />)}
